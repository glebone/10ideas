...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(getIdeasAfterLogin) name:@"needUpdateIdeas" object:nil];
    ...
    if (![[NSUserDefaults standardUserDefaults] valueForKey:@"userId"])
    {
        ...
        self.myIdeas = [Idea getRemoteIdeas];
...
- (void) getIdeasAfterLogin
{
    self.myIdeas = [Idea getRemoteIdeas];
    self.publicIdeas = [Idea getRemotePublicIdeas]; 
    [[NSNotificationCenter defaultCenter] postNotificationName:@"myUpdated" object:self];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"publicUpdated" object:self];
}
